plot4 <- function(){
  ...
  par(mfrow = c(2,2))
  par(mar = c(4,4,1,1))
  plot(sub$DateTime, sub$Global_active_power, type = "l", main = "" , xlab = "", ylab = "Global Active Power")
  plot(sub$DateTime, sub$Voltage, type = "l", main = "" , xlab = "datetime", ylab = "Voltage")
  ...
  legend('topright', names(sub[,7:9]), col =c("black","red","blue"), lwd = 1, cex = .75, bty = "n")
  plot(sub$DateTime, sub$Global_reactive_power, type = "l", main = "" , xlab = "datetime", ylab = "Global_reactive_power")
